...
// 加载索引
let retrievalIndex: any = null
let embeddingService: EmbeddingService | null = null
let retrievalEngine: RetrievalEngine | null = null
let qaGenerator: QAGenerator | null = null
 ...
 * 问答接口
 */
export async function queryRAG(req: Request, res: Response<ApiResponse<any>>): Promise<void> {
    try {
 ...
 * 搜索文档片段
 */
export async function searchDocuments(req: Request, res: Response<ApiResponse<any[]>>): Promise<void> {
    try {
        const { q } = req.query
