 ...
 * 获取支持的模型列表
 */
export async function getSupportedModels(req: Request, res: Response<ApiResponse<any[]>>): Promise<void> {
    try {
 ...
 * 验证API密钥
 */
export async function validateApiKey(req: Request, res: Response<ApiResponse<any>>): Promise<void> {
    try {
 ...
 * 获取项目配置状态
 */
export async function getProjectConfigStatus(req: Request, res: Response<ApiResponse<any>>): Promise<void> {
    try {
 ...
 * 获取索引状态
 */
export async function getIndexStatus(req: Request, res: Response<ApiResponse<any>>): Promise<void> {
    try {
 ...
 * 获取构建进度
 */
export async function getBuildProgress(req: Request, res: Response<ApiResponse<any>>): Promise<void> {
    try {
 ...
 * 删除文档索引
 */
export async function deleteDocumentIndex(req: Request, res: Response<ApiResponse<void>>): Promise<void> {
    try {
 ...
 * 删除全部索引
 */
export async function deleteAllIndex(req: Request, res: Response<ApiResponse<void>>): Promise<void> {
    try {
 ...
 * 构建索引（完整流程）
 */
export async function buildIndex(req: Request, res: Response<ApiResponse<any>>): Promise<void> {
    try {
 ...
 * 异步构建索引
 */
async function buildIndexAsync(taskId: string, documentId: string, mode: string) {
    try {
        // 这里应该从数据库获取文档信息
        // 暂时使用示例路径
